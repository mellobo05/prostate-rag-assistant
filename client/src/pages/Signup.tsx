      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-8">
          <div className="flex items-start gap-3">
            <div className="p-3 rounded-xl bg-white dark:bg-card shadow-sm text-primary"><BarChart3 className="w-6 h-6" /></div>
            <div className="text-left">
              <h3 className="font-semibold text-foreground">Track Reports & PSA</h3>
              <p className="text-sm text-muted-foreground">Keep all medical data organized</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <div className="p-3 rounded-xl bg-white dark:bg-card shadow-sm text-primary"><HeartPulse className="w-6 h-6" /></div>
            <div className="text-left">
              <h3 className="font-semibold text-foreground">AI Analysis</h3>
              <p className="text-sm text-muted-foreground">Get treatment summaries instantly</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <div className="p-3 rounded-xl bg-white dark:bg-card shadow-sm text-primary"><Mic className="w-6 h-6" /></div>
            <div className="text-left">
              <h3 className="font-semibold text-foreground">Voice Companion</h3>
              <p className="text-sm text-muted-foreground">Gentle, voice-based support for patients</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <div className="p-3 rounded-xl bg-white dark:bg-card shadow-sm text-primary"><Activity className="w-6 h-6" /></div>
            <div className="text-left">
              <h3 className="font-semibold text-foreground">Telegram Bot</h3>
              <p className="text-sm text-muted-foreground">Chat anytime from Telegram</p>
            </div>
          </div>
        </div>
      </motion.div>
      ...
      >
        <div className="glass-card p-8 sm:p-10 rounded-3xl flex flex-col items-center text-center space-y-8 relative overflow-hidden">
          ...
          <div className="space-y-2 relative z-10">
            ...
            <p className="text-muted-foreground">Start tracking your cancer care journey in minutes. Completely free.</p>
          </div>
